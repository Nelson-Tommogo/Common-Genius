  ...
  return (
    <div className="flex flex-col md:flex-row gap-8 w-full max-w-6xl mx-auto items-center mb-16">
      ...
      <div className="w-full md:w-1/2 space-y-4">
        <h2 className="text-2xl font-bold text-gray-800">Hello I'm Nelson Tommogo</h2>
        ...
        <div className="flex gap-2 pt-2 flex-wrap">
          <a 
            ...
            className="px-3 py-1 bg-gray-800 text-white rounded-lg hover:bg-gray-900 transition-colors flex items-center gap-2"
          >
          ...
          <a 
            ...
            target="_blank" 
            rel="noopener noreferrer"
            className="px-6 py-2 bg-blue-900 text-white rounded-lg hover:bg-blue-500 transition-colors flex items-center gap-2"
          >
