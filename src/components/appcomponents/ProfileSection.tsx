    ...
    <div className="flex flex-col md:flex-row gap-6 md:gap-8 w-full max-w-6xl mx-auto items-center mb-12 md:mb-16">
      ...
      <div className="w-full md:w-1/2 flex flex-col gap-3">
        <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-gray-800">
          Hello, I'm <span className="text-blue-900">Nelson Tommogo</span>
        </h2>

        <div>
          <p className="text-blue-900 font-semibold text-sm sm:text-base md:text-lg tracking-wide">
            Founder &amp; CEO <span className="text-blue-500/50 mx-1">|</span> Senior Software Engineer <span className="text-blue-500/50 mx-1">|</span> MSc Cyber Security &amp; Digital Forensics{" "}
        ...
        <div className="flex gap-3 pt-1 flex-wrap">
          <a 
            ...
            className="px-4 md:px-5 py-2 md:py-2.5 bg-gray-800 text-white rounded-lg hover:bg-gray-900 transition-colors flex items-center gap-2 text-sm md:text-base"
          >
